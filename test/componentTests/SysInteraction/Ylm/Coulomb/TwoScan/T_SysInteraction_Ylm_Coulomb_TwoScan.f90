program T_SysInteraction_Ylm_Coulomb_TwoScan
  use M_Utils_Types
  use M_Utils_Say
  use M_Utils_Json
  ...
  jsonFileName = "test/componentTests/SysInteraction/Ylm/Coulomb/TwoScan/T_SysInteraction_Ylm_Coulomb_TwoScan.json"
  ...
  call check(error, avgError / avgPot < 1e-2_R64)
  if (allocated(error)) error stop "T_SysInteraction_04_Ylm_Coulomb_TwoScan failure"
