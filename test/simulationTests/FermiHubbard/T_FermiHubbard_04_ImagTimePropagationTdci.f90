program T_FermiHubbard_04_ImagTimePropagationTdci
  use M_Utils_Types
  use M_Utils_Say
  use M_Utils_Json
  use M_Utils_Actions
  ...
  jsonFileName = "test/simulationTests/FermiHubbard/T_FermiHubbard_04_ImagTimePropagationTdci.json"
  ...
  if (allocated(error)) error stop "T_FermiHubbard_ImagTimePropagationTdci failure"
