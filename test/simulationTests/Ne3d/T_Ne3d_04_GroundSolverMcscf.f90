program T_Ne3d_04_GroundSolverMcscf
  use M_Utils_Types
  use M_Utils_Say
  use M_Utils_Json
  use M_Utils_Actions
  ...
  jsonFileName = "test/simulationTests/Ne3d/T_Ne3d_04_GroundSolverMcscf.json"
  ...
  DiagonalizerListInput(2) % ApplyMatOnVec => GroundSolver_Mcscf_FockAction
  ...
  if (allocated(error)) error stop "T_Ne3d_04_GroundSolverMcscf failure"
