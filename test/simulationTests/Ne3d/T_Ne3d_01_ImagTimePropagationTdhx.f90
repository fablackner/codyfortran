program T_Ne3d_01_ImagTimePropagationTdhx
  use M_Utils_Types
  use M_Utils_Say
  use M_Utils_Json
  use M_Utils_Actions
  ...
  jsonFileName = "test/simulationTests/Ne3d/T_Ne3d_01_ImagTimePropagationTdhx.json"
  ...
  call check(error, energyNew, -108.8479585_R64, thr=1e-6_R64)
  if (allocated(error)) error stop "T_Ne3d_01_ImagTimePropagationTdhx failure"
