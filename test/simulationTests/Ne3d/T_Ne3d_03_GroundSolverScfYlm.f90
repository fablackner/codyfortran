program T_Ne3d_03_GroundSolverScfYlm
  use M_Utils_Types
  use M_Utils_Say
  use M_Utils_Json
  use M_Utils_Actions
  ...
  jsonFileName = "test/simulationTests/Ne3d/T_Ne3d_03_GroundSolverScfYlm.json"
  ...
  if (allocated(error)) error stop "T_Ne3d_03_GroundSolverScfYlm failure"
