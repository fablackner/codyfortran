program T_BoseHubbard_03_ImagTimePropagationTdci
  use M_Utils_Types
  use M_Utils_Say
  use M_Utils_Json
  use M_Utils_Actions
  ...
  jsonFileName = "test/simulationTests/BoseHubbard/T_BoseHubbard_03_ImagTimePropagationTdci.json"
  ...
  if (allocated(error)) error stop "T_BoseHubbard_ImagTimePropagationTdci failure"
