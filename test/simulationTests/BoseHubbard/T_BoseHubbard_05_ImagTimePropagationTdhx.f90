program T_BoseHubbard_05_ImagTimePropagationTdhx
  use M_Utils_Types
  use M_Utils_Say
  use M_Utils_Json
  use M_Utils_Actions
  ...
  jsonFileName = "test/simulationTests/BoseHubbard/T_BoseHubbard_05_ImagTimePropagationTdhx.json"
  ...
  call check(error, energyNew, -14.5_R64, thr=1e-7_R64)
  if (allocated(error)) error stop "T_BoseHubbard_ImagTimePropagationTdhx failure"
