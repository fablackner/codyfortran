program T_BoseHubbard_04_ImagTimePropagationMctdhx
  use M_Utils_Types
  use M_Utils_Say
  use M_Utils_Json
  use M_Utils_Actions
  ...
  jsonFileName = "test/simulationTests/BoseHubbard/T_BoseHubbard_04_ImagTimePropagationMctdhx.json"
  ...
  call check(error, energyNew, -14.60164824_R64, thr=1e-7_R64)
  if (allocated(error)) error stop "T_BoseHubbard_ImagTimePropagationMctdhx failure"
