program T_SysInteraction_Ylm_Coulomb_BlockEq
  use M_Utils_Types
  use M_Utils_Say
  use M_Utils_Json
  ...
  jsonFileName = "test/T_SysInteraction_Ylm_Coulomb_BlockEq.json"
  ...
  if (allocated(error)) error stop "T_SysInteraction_03_Ylm_Coulomb_BlockEq failure"
