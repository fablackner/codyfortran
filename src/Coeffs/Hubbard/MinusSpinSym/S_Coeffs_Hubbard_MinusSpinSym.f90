...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
submodule(M_Coeffs_Hubbard_MinusSpinSym) S_Coeffs_Hubbard_MinusSpinSym
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  module subroutine Coeffs_Hubbard_MinusSpinSym_Fabricate
    ...
    call Say_Fabricate("coeffs.hubbard.minusSpinSym")
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  subroutine ApplyH1FillRdm1(coeffs, rdm1_, dCoeffs_, h1_)
    ...
    Do i2 = 1, Coeffs_Hubbard_nCoeffsUP
      Do i1 = 1, i2 - 1
        iCoeff = (i2 - 2) * (i2 - 1) / 2 + i1

        coeffsReshape(i1, i2) = coeffs(iCoeff) / sqrt(2.0_R64)

      end do
      coeffsReshape(i2, i2) = 0.0_R64
    end do
    !$omp end do
